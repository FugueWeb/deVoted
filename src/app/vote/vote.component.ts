...
export class VoteComponent implements OnInit {
  ...
  async newElection() {
    ...
    try {
      const deployedElection = await this.ELECTION.deployed();
      this.web3Service.newElection(deployedElection, this.election.prop0,
  ...
  async registerToVote() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.registerToVote(deployedElection, 
  ...
  async registerForElection() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.registerForElection(deployedElection, 
  ...
  async vote() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.vote(deployedElection, 
  ...
  async delegate() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.delegate(deployedElection, 
  ...
  async changeVote() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.changeVote(deployedElection, 
  ...
  async getElectionWinner(eID) {
    ...
    try {
      let result = await this.web3Service.getBlockStamp();
  ...
  async revokeVoter() {
      ...
      try {
        const deployedElection = await this.ELECTION.deployed();
        await this.web3Service.revokeVoter(deployedElection, 
